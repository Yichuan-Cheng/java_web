...
<div id="showpost">
	<div class="header">
		<a href="showPage.jsp" style="color:#FFFFFF;font-size=16px">返回</a>
	</div>
		<%
	...
	ResultSet rs = service.executeQuery1(sql);
		...
		<div class="title">
			...
			<div style="background-color: #FFF0F5;margin: 10px 20px;width:95%;">
	...
	<form action="reply.jsp?img=<%=img%>">
	 ...
	 <br>
	 <button class = "buttonpink" type = "submit">回复</button>
...
<div class="reply-words" style="text-align: center;">
	...
	<br>
	<a href="showPost.jsp?showPage=1&img=<%=img%>" style="color: #1C86EE;">首页</a>
	<a href="showPost.jsp?showPage=<%=showPage - 1%>&img=<%=img%>" style="color: #1C86EE;">上一页</a>
	<%
	//根据pageCount的值显示每一页的数字并附加上相应的超链接
	for (int i = 1; i <= pageCount; i++) {
	%>
	<a href="showPost.jsp?showPage=<%=i%>&img=<%=img%>" style="color: #1C86EE;"><%=i%></a>
	<%
	}
	%>
	<a href="showPost.jsp?showPage=<%=showPage + 1%>&img=<%=img%>" style="color: #1C86EE;">下一页</a>

	<a href="showPost.jsp?showPage=<%=pageCount%>&img=<%=img%>" style="color: #1C86EE;">末页</a>
	...
	<a href="showPage.jsp" style="color: #1C86EE;">返回</a>
</div>
</div>
</body>
<style>
